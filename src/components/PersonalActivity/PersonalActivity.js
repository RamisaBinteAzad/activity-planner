        ...
        <div className='personal-activity'>
            ...
            <div className=" py-3 pe-1   mb-4 mx-3 border border-light bg-light rounded mt-4 text-center">
                <div className="row row-cols-5 ">
                    <div className="col">
                        <button className="btn btn btn-primary py-2 px-1 rounded-circle" type="submit">10m</button>
                    </div>
                    <div className="col">
                        <button className="btn btn btn-primary py-2 px-1 rounded-circle" type="submit">20m</button>

                    </div>
                    <div className="col">
                        <button className="btn btn btn-primary py-2 px-1 rounded-circle" type="submit">30m</button>
                    </div>
                    <div className="col">
                        <button className="btn btn btn-primary py-2 px-1 rounded-circle" type="submit">40m</button>
                    </div>
                    <div className="col">
                        <button className="btn btn btn-primary py-2 px-1 rounded-circle" type="submit">50m</button>
                    </div>
                </div>
